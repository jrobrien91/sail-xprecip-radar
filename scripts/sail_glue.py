...
def granule(Dvolume):
    ...
    out_dir = '/gpfs/wolf2/arm/atm124/proj-shared/gucxprecipradarS2.00/glue_files/%s_glued/' % month
...
def main(args):
    ...
    # Define directories
    month = args.month
    path = '/gpfs/wolf2/arm/atm124/proj-shared/gucxprecipradarS2.00/nc_files/%s_nc/*.nc' % month
    out_path = '/gpfs/wolf2/arm/atm124/proj-shared/gucxprecipradarS2.00/glue_files/%s_glued/' % month
